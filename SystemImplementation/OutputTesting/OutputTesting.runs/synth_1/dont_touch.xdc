...
# IP: bd/system/ip/system_single_inverter_controller_0_1/system_single_inverter_controller_0_1.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_single_inverter_controller_0_1 || ORIG_REF_NAME==system_single_inverter_controller_0_1}]

# IP: bd/system/ip/system_single_inverter_controller_1_1/system_single_inverter_controller_1_1.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_single_inverter_controller_1_1 || ORIG_REF_NAME==system_single_inverter_controller_1_1}]
